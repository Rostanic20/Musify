...
object AppConfig {
    ...
    val jwtExpirationMs: Long get() = EnvironmentConfig.JWT_ACCESS_TOKEN_EXPIRY_MINUTES * 60 * 1000
    ...
    val rateLimitPremiumUsers: Int get() = 200
    
    // Feature Flags
    val emailVerificationEnabled: Boolean get() = EnvironmentConfig.EMAIL_ENABLED
    val registrationEnabled: Boolean get() = true
