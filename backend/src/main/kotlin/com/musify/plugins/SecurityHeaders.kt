...
fun Application.configureSecurityHeaders() {
    ...
    if (EnvironmentConfig.ENVIRONMENT != "test") {
        log.info("Enhanced security headers configured for ${EnvironmentConfig.ENVIRONMENT} environment")
        ...
        if (EnvironmentConfig.IS_PRODUCTION) {
            ...
            log.warn("  Development mode: CSP allows unsafe-inline and unsafe-eval")
        }
    }
}